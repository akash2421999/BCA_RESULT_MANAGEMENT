...
$sql="update  subjects set SubjectName=:subjectname,Compounent=:compounent,SubjectCode=:subjectcode where id=:sid";
...
{   ?>                                               
 ...
 <input type="text" name="subjectname" value="<?php echo htmlentities($result->SubjectName);?>" class="form-control" id="default" placeholder="Subject Name" required="required">
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
 <input type="text" name="compounent" value="<?php echo htmlentities($result->Compounent);?>" class="form-control" id="default" placeholder="theory/IA/pratical" required="required">
                                                        </div>
                                                    </div>
<div class="form-group">
