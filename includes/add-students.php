...
<html lang="en">
    <head>
        ...
        <title>SMS Admin|Add Student< </title>
...
<div class="col-sm-10">
<input type="text" name="fullanme" class="form-control" maxlength="5" id="fullanme" required="required" autocomplete="off">
</div>
</div>
                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT .StudentName,tblstudents.RollId,tblstudents.Gender,tblstudents.StudentId,tblstudents.DOB,tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId";
$query = $dbh->prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
<td>
<a class="btn btn-primary" href="edit-student.php?stid=<?php echo htmlentities($result->StudentId);?>">Delete</a> 
